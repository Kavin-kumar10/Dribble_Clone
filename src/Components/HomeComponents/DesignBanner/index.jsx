...
const DesignBanner = () =>{
    return(
        <div className="DesignBanner sm:h-[100vh] md:h-[85vh] w-screen text-center font-light bg-[#ffda79] gap-10 flex items-center justify-center flex-col p-5">
            ...
            <div className="flex items-center gap-5 flex-wrap justify-center">
                ...
                <button className="font-semibold px-4 py-3 md:px-6 md:py-4 bg-secondary text-primary border border-secondary rounded-full">Learn about hiring</button>
            </div>
