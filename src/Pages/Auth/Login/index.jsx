            ...
            <div className="flex flex-col items-center justify-center w-full h-full">
                <form onSubmit={handleSubmit} className="w-full p-10 sm:p-0 sm:w-1/2 md:w-1/3 gap-5">
                    ...
                    <div className="flex flex-col gap-2 my-5">
                        ...
                        <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} id="user" className="border px-4 py-4 rounded-2xl outline-none focus:shadow-md hover:shadow-xl"
  style={{ boxShadow: 'rgba(234, 100, 217, 0.1) 0px 0px 0px 4px;' }}  />
                    </div>
                    <div className="flex flex-col gap-2 my-5">
                        <label htmlFor="password">Password</label>
                        <input type="password" value={password} onChange={(e) => setPassword(e.target.value)}  id="password"  className="border px-4 py-4 rounded-2xl outline-none focus:shadow-md hover:shadow-xl"
  style={{ boxShadow: 'rgba(234, 100, 217, 0.1) 0px 0px 0px 4px;' }} />
                    </div>
